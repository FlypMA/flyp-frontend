...
const FavoriteBusinesses: React.FC<FavoriteBusinessesProps> = () => {
  ...
  const [filter, setFilter] = useState<
    'all' | 'watching' | 'contacted' | 'evaluating' | 'negotiating' | 'passed'
  >('all');
      ...
      const mockFavorites: FavoriteBusiness[] = [
        {
          ...
          currency: 'EUR',
          summary:
            'Established restaurant chain with 3 prime Brussels locations. Strong customer base, proven systems, and excellent growth potential.',
          views: 245,
        ...
        },
        {
          ...
          currency: 'EUR',
          summary:
            'Growing B2B SaaS company specializing in enterprise workflow solutions. Strong recurring revenue model.',
          views: 189,
        ...
        },
        {
          ...
          currency: 'EUR',
          summary:
            'Full-service digital marketing agency with 50+ active clients and experienced team.',
          views: 123,
        ...
        },
        {
          ...
          currency: 'EUR',
          summary:
            'Specialty coffee roastery with loyal local customer base and growing online sales.',
          views: 78,
