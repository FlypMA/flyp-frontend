...
const InquiryManagement: React.FC<InquiryManagementProps> = () => {
      ...
      const mockInquiries: Inquiry[] = [
        {
          ...
          initial_message:
            'I am very interested in your restaurant chain. I have experience in the hospitality industry and would like to discuss the opportunity further.',
          message_count: 8,
          unread_messages: 2,
          nda_status: 'signed',
        ...
        },
        {
          ...
          initial_message:
            'Your SaaS platform looks very promising. I would like to learn more about the technical architecture and customer base.',
          message_count: 3,
          unread_messages: 1,
          nda_status: 'required',
        ...
        },
        {
          ...
          initial_message:
            'I am interested in acquiring a marketing agency to expand my business portfolio. Your client base looks impressive.',
          message_count: 5,
          unread_messages: 0,
          nda_status: 'none',
        ...
        },
        {
          ...
          initial_message:
            'I represent a manufacturing group looking to expand in Belgium. Your precision manufacturing capabilities align with our strategic goals.',
          message_count: 12,
          unread_messages: 0,
          nda_status: 'signed',
    ...
    try {
      ...
      const mockMessages: Message[] = [
        ...
        },
        {
          ...
          content:
            'Thank you for your interest! I would be happy to discuss the opportunity. Could you tell me more about your background in hospitality?',
        ...
        },
        {
          ...
          sender_name: 'You',
          content:
            'I have been in the restaurant industry for 15 years, having owned and operated 2 successful restaurants in Ghent. I am now looking to expand into Brussels with an established brand.',
        ...
        },
        {
          ...
          sender_name: 'Marie Dupont',
          content:
            'That sounds excellent! Your experience would be perfect for our chain. I would like to schedule a call to discuss the details. Are you available this week?',
      ...
      setInquiries(prev =>
        prev.map(inq =>
          inq.id === selectedInquiry.id
            ? {
                ...inq,
                message_count: inq.message_count + 1,
  ...
  const filteredInquiries = inquiries.filter(inquiry => {
    ...
    if (activeTab === 'active')
      return ['replied', 'active', 'negotiating'].includes(inquiry.status);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">
            ...
            {inquiries.filter(i => i.unread_messages > 0).length} with unread messages
          </p>
        </div>
      ...
      >
        ...
        <Tab
          key="active"
          title={`Active (${inquiries.filter(i => ['replied', 'active', 'negotiating'].includes(i.status)).length})`}
        />
        <Tab
          key="pending"
          title={`Pending (${inquiries.filter(i => ['sent', 'viewed', 'nda_required'].includes(i.status)).length})`}
        />
        <Tab
          key="closed"
          title={`Closed (${inquiries.filter(i => i.status === 'closed').length})`}
        />
      </Tabs>
                ...
                <div className="flex items-start justify-between w-full">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {formatPrice(
                            selectedInquiry.listing_asking_price,
                            selectedInquiry.listing_currency
                          )}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-600">
                        with {selectedInquiry.seller_name}
                      </span>
                    </div>
                  </div>
                  ...
                  <Dropdown>
                    ...
                    <DropdownMenu>
                      <DropdownItem
                        key="view"
                        onPress={() => navigate(`/listings/${selectedInquiry.listing_id}`)}
                      >
                        View Listing
                      </DropdownItem>
                      <DropdownItem key="info">Inquiry Details</DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                </div>
              </CardHeader>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span
                            className={`text-xs ${message.sender_type === 'buyer' ? 'text-primary-100' : 'text-gray-500'}`}
                          >
