// 🏢 ListingDetails - Detailed business listing view matching legacy exactly
// Location: src/features/listings/pages/ListingDetails.tsx
// Purpose: Airbnb-style detail page with image gallery and inquiry functionality
...
import { ImageGalleryModal, InquiryModal } from '../components';
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-amber-800 leading-relaxed">
                            Detailed financial statements, cash flow analysis, and sensitive
                            business metrics are available to qualified buyers after NDA execution.
                            This includes P&L statements, balance sheets, and growth projections.
                          </p>
                        </div>
                      </div>
                    </div>
