// 🔍 ListingSearch - Main search page matching legacy exactly
// Location: src/features/search/pages/ListingSearch.tsx
// Purpose: Business search with filters, pagination, and saved searches

import React, { useState, useEffect } from 'react';
import { useSearchParams, useNavigate } from 'react-router-dom';
import { Button, Card, CardBody, Pagination } from '@heroui/react';
import { Search, Building2, MessageSquare, Shield, Bell } from 'lucide-react';
import { SearchComponent, PriceRangeSlider, ListingCard, SaveSearchModal } from '../components';
