// 🎯 Clean Buyer Wizard - Modular Architecture
// Location: src/features/authentication/components/BuyerWizardClean.tsx
// Purpose: Clean, modular buyer onboarding wizard (replaces 1,044-line monolith)
...
/**
 * BuyerWizardClean - Modern, Modular Buyer Onboarding
 *
 ...
 */
export const BuyerWizardClean: React.FC = () => {
  const {
    // State
    currentStep,
    showSuccess,
...
export default BuyerWizardClean;
