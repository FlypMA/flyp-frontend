// 🏢 Business Type Selection - Business Card Feature
// Location: src/features/phase1/business/card/components/BusinessTypeSelection.tsx
// Purpose: Business type selection step for business card creation (adapted from listing prelude)
// Note: Preserves Airbnb-inspired UI from original prelude design

import React from 'react';
import { BusinessCardStepProps, BusinessType, BusinessTypeOption } from '../types';
...
const BusinessTypeSelection: React.FC<BusinessCardStepProps> = ({ data, onDataChange, onNext }) => {
