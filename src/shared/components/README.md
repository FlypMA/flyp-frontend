...
This directory contains a comprehensive library of reusable React components for the flyp application. All components follow consistent design patterns, accessibility standards, and are built with TypeScript for type safety.
...
export const Component: React.FC<ComponentProps> = ({ children, className = '', ...props }) => {
  return (
