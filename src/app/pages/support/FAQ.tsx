// ❓ FAQ Page - Frequently Asked Questions matching legacy exactly
// Location: src/app/pages/support/FAQ.tsx
// Purpose: Provide FAQ section matching legacy design exactly
        ...
        <div className="space-y-8">
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <p className="text-gray-700">
              BetweenDeals connects business buyers and sellers in a secure marketplace environment,
