// 🎯 Sellers Landing Page - Comprehensive page for business sellers
// Location: src/app/pages/landingPages/sellers.tsx
// Purpose: Convert businesses owners to list their business for sale
...
// TODO: Import SEO and auth service when available
...
const SellersLandingPage = () => {
  ...
  // Handle Sell Your Business button click - Smart routing based on authentication (matching legacy exactly)
  const handleListBusinessClick = async () => {
    try {
      // TODO: Replace with actual auth service check when available
      // const authResult = await authService.checkAuthentication();

      // For now, simulate the logic from legacy app
      const mockAuthResult = { isAuthenticated: false, user: null };

      if (mockAuthResult.isAuthenticated && mockAuthResult.user) {
        // User is logged in - check their role
        const userRole = mockAuthResult.user.role;
        ...
        // User is not logged in, show signup modal with seller intent (matching legacy)
        openModal('signup', {
          url: '/my-business',
      ...
      // On error, default to showing signup modal (matching legacy fallback)
      openModal('signup', {
        url: '/my-business',
        state: { from: 'seller-landing', intent: 'seller' },
      });
  ...
  const benefitsData = [
    {
      icon: Users,
      title: 'Connect with qualified buyers',
      description:
        'Access thousands of pre-screened investors, acquirers, and entrepreneurs actively seeking business opportunities in Belgium.',
    },
    {
      icon: Euro,
      title: 'Get the best price',
      description:
        'Competitive marketplace dynamics and transparent pricing help you achieve maximum value for your business.',
    },
    {
      icon: Clock,
      title: 'Sell faster',
      description:
        'Our streamlined process and dedicated support team help you close deals 3x faster than traditional methods.',
    },
  ];
  ...
  const testimonialsData = [
    {
      ...
      testimonial:
        'betweendeals helped me sell my IT consultancy in just 3 months. The platform connected me with serious buyers and the process was completely transparent.',
      avatar:
        'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
    },
    {
      name: 'Marie Dubois',
      company: 'Café Central Brussels',
      testimonial:
        'I was skeptical about selling online, but betweendeals made it easy. They handled everything professionally and I got a great price for my restaurant.',
      avatar:
        'https://images.unsplash.com/photo-1494790108755-2616c0763c65?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
    },
  ];

  const statsData = [
    { number: '€2.1M', label: 'Average Sale Price' },
    { number: '45', label: 'Days Average Sale' },
    { number: '890+', label: 'Businesses Sold' },
          ...
          <Container>
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-8 leading-tight">
                Sell your business
                <span className="block text-blue-600">on Belgium's #1 platform</span>
              </h1>

              <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                Connect with 10,000+ qualified buyers and investors. Join 890+ successful Belgian
                business owners who sold through betweendeals.
              </p>
