  ...
  return (
    <div className="space-y-6">
          ...
          {storageInfo.percentage > 80 && (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <p className="text-sm text-gray-700">
                Storage is {storageInfo.percentage.toFixed(0)}% full. Consider upgrading to Premium
      ...
      {filteredDocuments.length === 0 ? (
        ...
        <div
          className={viewMode === 'grid' ? 'grid md:grid-cols-4 lg:grid-cols-5 gap-4' : 'space-y-2'}
        >
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                Your documents are encrypted before upload and stored on secure EU servers. Access
                is logged and monitored for your protection.
              </p>
            </div>
          </div>
        </CardBody>
