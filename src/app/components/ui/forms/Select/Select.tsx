  ...
  const renderSelectItem = (option: OptionItem) => {
    const content = renderOption ? renderOption(option) : (
      <div className="select-option-content">
        <div className="select-option-label font-medium text-gray-900">
          {option.label}
        </div>
        {option.description && (
      ...
      <HeroSelect
        ...
        classNames={{
          ...
          trigger: cn(
            ...
            currentError && "border-red-500 hover:border-red-500 data-[focus=true]:border-red-500 data-[open=true]:border-red-500"
          ),
          value: cn(
            "text-gray-900",
            {
