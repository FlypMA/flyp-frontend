    ...
    <div className="relative">
      ...
      >
        <input
          ...
          className={`w-full h-16 px-4 text-white pb-0 text-md bg-transparent text-foreground-500 focus:outline-none focus-visible:outline-none border-none rounded-xl focus:ring-2 focus:ring-white custom-input ${hasContent || isFocused ? 'bg-filled text-md pt-4 pl-4' : 'bg-transparent text-md pt-3 pl-4'} ${inputErrorClass}`}
          aria-label={label}
          value={input?.value || ''}
