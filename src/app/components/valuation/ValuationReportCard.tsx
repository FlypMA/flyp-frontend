...
import { DollarSign, TrendingUp, Calendar, FileText, Download, Eye, Calculator, RefreshCw, Share2, BookOpen } from 'lucide-react';
...
const ValuationReportCard: React.FC<ValuationReportCardProps> = ({
  ...
  const conservativeValue = valuation.conservative_value || Math.round(valuation.estimated_value * 0.8);
  ...
  const monthsSinceValuation = Math.floor((Date.now() - new Date(valuation.valuation_date).getTime()) / (1000 * 60 * 60 * 24 * 30));
      ...
      <CardBody className="p-8">
        ...
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500">{valuation.methodology} • Updated {formatDate(valuation.valuation_date)}</p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button 
                  ...
                  className="border-gray-300 text-gray-700 hover:bg-gray-50"
                  size="md"
                  onPress={() => {/* Navigate to valuation details */}}
                >
                  View Details
                </Button>
              </div>
