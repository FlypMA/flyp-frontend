...
const SimpleSupportSettings: React.FC<SimpleSupportSettingsProps> = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Basic listings are live immediately. Full verification typically takes 2-3 business days.',
    },
    {
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-6">
            {supportOptions.map((option, index) => {
              ...
              return (
                <div key={index} className="flex items-start justify-between p-6 border border-gray-200 rounded-xl hover:border-gray-300 transition-colors">
                  ...
                  <div className="ml-4">
                    {option.comingSoon ? (
                      ...
                      >
                        {option.action}
                        {!option.href.startsWith('mailto:') && <ExternalLink className="w-4 h-4 ml-2" />}
                      </Button>
                    )}
                  </div>
                </div>
