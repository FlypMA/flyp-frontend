...
import Heading1 from '../main_UI/fonts/heading1.tsx';
import { authService } from '../../services/users/authenticationService';
import UrlGeneratorService from '../../services/urlMapping/urlGeneratorService';
import CustomInputField from '../main_UI/forms/customInputField.tsx';
import CustomPasswordInputField from '../main_UI/forms/customPasswordInputtField.tsx';
                          ...
                          <div className="text-center space-y-8">
                            <div className="max-w-md mx-auto">
                              ...
                              <p className="text-gray-600 text-base leading-relaxed">
                                Join thousands of entrepreneurs and investors making 
                                successful connections in the M&A marketplace.
                              </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6 pt-8 max-w-xs mx-auto">
                              <div className="flex items-center space-x-3">
                                ...
                                <span className="text-sm text-gray-700">Verified opportunities</span>
                              </div>
                              <div className="flex items-center space-x-3">
                                <div className="w-8 h-8 rounded-lg bg-gray-200 flex items-center justify-center flex-shrink-0">
                                  <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
