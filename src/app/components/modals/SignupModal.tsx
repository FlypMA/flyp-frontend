...
const SignupModal: React.FC = () => {
  ...
  const handleSignup = async ({ email, password }: SignupData) => {
    console.log('SignupModal: Signing up...');
    ...
    try {
      ...
      // Pass empty string for name since we removed the name field, default to buyer role
      const response = await authService.createAccount(email, password, '', 'buyer');
