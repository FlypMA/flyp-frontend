...
const BusinessTypeAndIndustrySelector: React.FC<BusinessTypeAndIndustrySelectorProps> = ({ 
  ...
  const allIndustries: UnifiedIndustry[] = [
    // Technology & Software
    { value: 'saas', label: 'SaaS Platforms', name: 'SaaS Platforms', description: 'Software as a Service applications', category: 'Technology & Software', icon: '💻', emoji: '💻' },
    { value: 'mobile-apps', label: 'Mobile Applications', name: 'Mobile Applications', description: 'iOS, Android, cross-platform apps', category: 'Technology & Software', icon: '📱', emoji: '📱' },
    ...
    { value: 'fintech', label: 'Financial Technology', name: 'Financial Technology', description: 'Payment processing, digital banking', category: 'Technology & Software', icon: '💳', emoji: '💳' },
    ...
    { value: 'web-development', label: 'Web Development', name: 'Web Development', description: 'Website development, web apps', category: 'Technology & Software', icon: '🌐', emoji: '🌐' },
    ...
    // Retail & E-commerce
    { value: 'fashion', label: 'Fashion & Apparel', name: 'Fashion & Apparel', description: 'Clothing, accessories, footwear', category: 'Retail & E-commerce', icon: '👗', emoji: '👗' },
    ...
    { value: 'home-garden', label: 'Home & Garden', name: 'Home & Garden', description: 'Furniture, decor, home improvement', category: 'Retail & E-commerce', icon: '🏠', emoji: '🏠' },
    ...
    // Food & Beverage
    { value: 'restaurants', label: 'Restaurants & Cafes', name: 'Restaurants & Cafes', description: 'Dining establishments', category: 'Food & Beverage', icon: '🍽️', emoji: '🍽️' },
    ...
    { value: 'food-delivery', label: 'Food Delivery', name: 'Food Delivery', description: 'Delivery services', category: 'Food & Beverage', icon: '🚚', emoji: '🚚' },
    ...
    { value: 'gyms-fitness', label: 'Gyms & Fitness Centers', name: 'Gyms & Fitness Centers', description: 'Fitness facilities', category: 'Entertainment & Hospitality', icon: '🏋️', emoji: '🏋️' },
    ...
    { value: 'hotels-lodging', label: 'Hotels & Lodging', name: 'Hotels & Lodging', description: 'Accommodation', category: 'Entertainment & Hospitality', icon: '🏨', emoji: '🏨' },
    ...
    { value: 'construction', label: 'Construction', name: 'Construction', description: 'Building services', category: 'Construction & Real Estate', icon: '🏗️', emoji: '🏗️' },
    ...
    // Personal Services
    { value: 'cleaning-services', label: 'Cleaning Services', name: 'Cleaning Services', description: 'Cleaning businesses', category: 'Personal Services', icon: '🧽', emoji: '🧽' },
  ...
  const handleIndustrySelect = (industryValue: string) => {
    ...
    // Notify parent of selection (for continue button state)
        ...
        <div className="flex-shrink-0 bg-gradient-to-r from-blue-50 to-purple-50 border-t-2 border-blue-200 p-4 shadow-lg">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-3 mb-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold text-base">{selectedIndustryData.name}</h3>
